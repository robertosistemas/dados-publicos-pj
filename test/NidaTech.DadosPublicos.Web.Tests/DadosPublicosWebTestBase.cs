...
{
    public abstract class DadosPublicosWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DadosPublicosWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DadosPublicosWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DadosPublicosDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DadosPublicosDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DadosPublicosDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DadosPublicosDbContext, Task<T>> func)
        {
            T result;
