...
using NidaTech.DadosPublicos.Web.Models.Account;
using NidaTech.DadosPublicos.Web.Views.Shared.Components.TenantChange;

namespace NidaTech.DadosPublicos.Web.Controllers
{
    public class AccountController : DadosPublicosControllerBase
    {
        ...
        public ActionResult Login(string userNameOrEmailAddress = "", string returnUrl = "", string successMessage = "")
        {
            ...
            {
                returnUrl = "/backoffice"; // GetAppHomeUrl();
            }
