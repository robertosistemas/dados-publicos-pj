        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodigoSecao = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    NomeSecao = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CodigoDivisao = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true),
                    NomeDivisao = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CodigoGrupo = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    NomeGrupo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CodigoClasse = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: true),
                    NomeClasse = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Codigo = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    Descricao = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    QuantidadeEmpresasAtivas = table.Column<int>(type: "int", nullable: false),
                    QuantidadeEmpresasInativas = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AtividadeEconomica", x => x.Id);
                    table.UniqueConstraint("UK_AtividadeEconomica", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeArquivo = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    DataGravacao = table.Column<DateTime>(type: "DATE", nullable: false),
                    NumeroRemessa = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    DataImportacao = table.Column<DateTime>(type: "DATE", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ControleImportacao", x => x.Id);
                    table.UniqueConstraint("UK_ControleImportacao", x => x.NomeArquivo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Logico", x => x.Id);
                    table.UniqueConstraint("UK_Logico", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatrizFilial", x => x.Id);
                    table.UniqueConstraint("UK_MatrizFilial", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_MotivoSituacaoCadastral", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_NaturezaJuridica", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpcaoSimples", x => x.Id);
                    table.UniqueConstraint("UK_OpcaoSimples", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_Pais", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Porte", x => x.Id);
                    table.UniqueConstraint("UK_Porte", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_SituacaoCadastral", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_TipoSocio", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColetadoAtualmente = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Qualificacao", x => x.Id);
                    table.UniqueConstraint("UK_Qualificacao", x => x.Codigo);
                    table.ForeignKey(
                        name: "FK_Qualificacao_Logico",
                        column: x => x.ColetadoAtualmente,
                        principalTable: "Logico",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_UnidadeFederacao", x => x.Codigo);
                    table.ForeignKey(
                        name: "FK_UnidadeFederacao_Pais",
                        column: x => x.PaisId,
                        principalTable: "Pais",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnidadeFederacaoId = table.Column<int>(type: "int", nullable: true),
                    QuantidadeEmpresasAtivas = table.Column<int>(type: "int", nullable: false),
                    QuantidadeEmpresasInativas = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("UK_Municipio", x => x.Codigo);
                    table.ForeignKey(
                        name: "FK_Municipio_UnidadeFederacaoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatrizFilialId = table.Column<int>(type: "int", nullable: false),
                    RazaoSocialNomeEmpresarial = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    NomeFantasia = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: true),
                    SituacaoCadastralId = table.Column<int>(type: "int", nullable: true),
                    DataSituacaoCadastral = table.Column<DateTime>(type: "DATE", nullable: true),
                    MotivoSituacaoCadastralId = table.Column<int>(type: "int", nullable: true),
                    NomeCidadeExterior = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: true),
                    PaisId = table.Column<int>(type: "int", nullable: true),
                    NaturezaJuridicaId = table.Column<int>(type: "int", nullable: true),
                    DataInicioAtividade = table.Column<DateTime>(type: "DATE", nullable: true),
                    AtividadeEconomicaId = table.Column<int>(type: "int", nullable: true),
                    TipoLogradouro = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    Complemento = table.Column<string>(type: "nvarchar(156)", maxLength: 156, nullable: true),
                    ...
                    Ddd1 = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    Telefone1 = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    Ddd2 = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    Telefone2 = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    DddFax = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    Fax = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    CorreioEletronico = table.Column<string>(type: "nvarchar(115)", maxLength: 115, nullable: true),
                    QualificacaoResponsavelId = table.Column<int>(type: "int", nullable: true),
                    CapitalSocial = table.Column<decimal>(type: "DECIMAL(14,2)", nullable: true),
                    PorteId = table.Column<int>(type: "int", nullable: true),
                    OpcaoSimplesId = table.Column<int>(type: "int", nullable: true),
                    DataOpcaoSimples = table.Column<DateTime>(type: "DATE", nullable: true),
                    DataExclusaoSimples = table.Column<DateTime>(type: "DATE", nullable: true),
                    OpcaoMei = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    SituacaoEspecial = table.Column<string>(type: "nvarchar(23)", maxLength: 23, nullable: true),
                    DataSituacaoEspecial = table.Column<DateTime>(type: "DATE", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DadoCadastral", x => x.Id);
                    table.UniqueConstraint("UK_DadoCadastral", x => x.Cnpj);
                    table.ForeignKey(
                        name: "FK_DadoCadastral_AtivEcon",
                        column: x => x.AtividadeEconomicaId,
                        principalTable: "AtividadeEconomica",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_Logico",
                        column: x => x.OpcaoMei,
                        principalTable: "Logico",
                        principalColumn: "Codigo");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_MatrizFilial",
                        column: x => x.MatrizFilialId,
                        principalTable: "MatrizFilial",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DadoCadastral_MotiSitu",
                        column: x => x.MotivoSituacaoCadastralId,
                        principalTable: "MotivoSituacaoCadastral",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_Municipio",
                        column: x => x.MunicipioId,
                        principalTable: "Municipio",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_NatuJuri",
                        column: x => x.NaturezaJuridicaId,
                        principalTable: "NaturezaJuridica",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_OpcaoSimples",
                        column: x => x.OpcaoSimplesId,
                        principalTable: "OpcaoSimples",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_Pais",
                        column: x => x.PaisId,
                        principalTable: "Pais",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_Porte",
                        column: x => x.PorteId,
                        principalTable: "Porte",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_QualResp",
                        column: x => x.QualificacaoResponsavelId,
                        principalTable: "Qualificacao",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_SituCada",
                        column: x => x.SituacaoCadastralId,
                        principalTable: "SituacaoCadastral",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DadoCadastral_UnidFede",
                        column: x => x.UnidadeFederacaoId,
                        principalTable: "UnidadeFederacao",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cnpj = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: false),
                    AtividadeEconomicaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AtividadeEconomicaSecundaria", x => x.Id);
                    table.UniqueConstraint("UK_AtividadeEconomicaSecundaria", x => new { x.Cnpj, x.AtividadeEconomicaId });
                    table.ForeignKey(
                        name: "FK_AtivEconSecu_AtivEcon",
                        column: x => x.AtividadeEconomicaId,
                        principalTable: "AtividadeEconomica",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AtivEconSecu_DadoCadastral",
                        column: x => x.Cnpj,
                        principalTable: "DadoCadastral",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificacaoSocioId = table.Column<int>(type: "int", nullable: true),
                    PercentualCapitalSocial = table.Column<decimal>(type: "DECIMAL(14,2)", nullable: true),
                    DataEntradaSociedade = table.Column<DateTime>(type: "DATE", nullable: true),
                    PaisId = table.Column<int>(type: "int", nullable: true),
                    CpfRepresentanteLegal = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
                    NomeRepresentanteLegal = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    QualificacaoRepresentanteId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Socio", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Socio_DadoCadastral",
                        column: x => x.Cnpj,
                        principalTable: "DadoCadastral",
                        principalColumn: "Cnpj",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Socio_QualificacaoRepr",
                        column: x => x.QualificacaoRepresentanteId,
                        principalTable: "Qualificacao",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Socio_QualificacaoSocio",
                        column: x => x.QualificacaoSocioId,
                        principalTable: "Qualificacao",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Socio_TipoSocio",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AtividadeEconomicaSecundaria_AtividadeEconomicaId",
                table: "AtividadeEconomicaSecundaria",
                column: "AtividadeEconomicaId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_AtividadeEconomicaId",
                table: "DadoCadastral",
                column: "AtividadeEconomicaId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_MatrizFilialId",
                table: "DadoCadastral",
                column: "MatrizFilialId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_MotivoSituacaoCadastralId",
                table: "DadoCadastral",
                column: "MotivoSituacaoCadastralId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_MunicipioId",
                table: "DadoCadastral",
                column: "MunicipioId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_NaturezaJuridicaId",
                table: "DadoCadastral",
                column: "NaturezaJuridicaId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_OpcaoMei",
                table: "DadoCadastral",
                column: "OpcaoMei");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_OpcaoSimplesId",
                table: "DadoCadastral",
                column: "OpcaoSimplesId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_PaisId",
                table: "DadoCadastral",
                column: "PaisId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_PorteId",
                table: "DadoCadastral",
                column: "PorteId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_QualificacaoResponsavelId",
                table: "DadoCadastral",
                column: "QualificacaoResponsavelId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_SituacaoCadastralId",
                table: "DadoCadastral",
                column: "SituacaoCadastralId");

            migrationBuilder.CreateIndex(
                name: "IX_DadoCadastral_UnidadeFederacaoId",
                table: "DadoCadastral",
                column: "UnidadeFederacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Municipio_UnidadeFederacaoId",
                table: "Municipio",
                column: "UnidadeFederacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Qualificacao_ColetadoAtualmente",
                table: "Qualificacao",
                column: "ColetadoAtualmente");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Socio_PaisId",
                table: "Socio",
                column: "PaisId");

            migrationBuilder.CreateIndex(
                name: "IX_Socio_QualificacaoRepresentanteId",
                table: "Socio",
                column: "QualificacaoRepresentanteId");

            migrationBuilder.CreateIndex(
                name: "IX_Socio_QualificacaoSocioId",
                table: "Socio",
                column: "QualificacaoSocioId");

            migrationBuilder.CreateIndex(
                name: "IX_Socio_TipoSocioId",
                table: "Socio",
                column: "TipoSocioId");

            migrationBuilder.CreateIndex(
                name: "IX_UnidadeFederacao_PaisId",
