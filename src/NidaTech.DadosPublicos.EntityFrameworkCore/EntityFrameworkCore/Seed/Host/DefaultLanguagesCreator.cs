...
namespace NidaTech.DadosPublicos.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = DadosPublicosConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DadosPublicosDbContext context)
        {
            _context = context;
        }
